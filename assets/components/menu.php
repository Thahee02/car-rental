...
<header class="header">
    ...
    <nav class="nav">
        ...
        <ul class="menu">
            <li><a href="http://localhost/car/index.php" class="menu-item">Home</a></li>
            <li><a href="http://localhost/car/rentacar.php" class="menu-item">Rent a Car</a></li>
            <li><a href="http://localhost/car/index.php#about-us" class="menu-item">About</a></li>
            <li><a href="http://localhost/car/contact.php" class="menu-item">Contact Us</a></li>
            ...
            if(isset($_SESSION['is_login'])){ 
                ...
                <li class="user-profile" onclick="toggleSubmenu()">
                    <a href="http://localhost/car/profile.php">
...
<div class="side-menu" id="sideMenu">
    <ul>
        <li><a href="http://localhost/car/index.php" class="side-menu-item">Home</a></li>
