...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['rent_id'])) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['modal_message'] = "Rent deleted successfully.";
        header("Location: http://localhost/car/admin/rents.php");
        exit();
    } else {
        ...
        $_SESSION['modal_message'] = "Failed to delete rent: " . $conn->error;
        header("Location: http://localhost/car/admin/rents.php");
        exit();
    }
} else {
